...
protected:
	...
	std::string get_assembled_file_name(int round, int k);
	...
	Assemble_stat get_assemble_stat(int round, int k);
	...
	int num_rounds;
	unsigned int min_contig_size;
	unsigned int max_contig_size;
	int verbose;
